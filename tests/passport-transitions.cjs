...
vm.runInNewContext(source, { module:moduleShim, exports:moduleShim.exports, require(name) {
...
console.log('PASS: ES/EN open, turn, close on animation end, reopen, reverse.');
